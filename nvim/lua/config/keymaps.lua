...
--
--   h.mapl_n('ff', fzf.files, 'Find Files')
--   h.mapl_n('fo', fzf.oldfiles, 'Find Old Files')
--   h.mapl_n('fb', fzf.buffers, 'Find Buffers')
--   h.mapl_n('fs', fzf.lsp_document_symbols, 'Find Symbols')
--   -- h.mapl_n('fS', tb.treesitter, 'Find Symbols (treesitter)')
--   h.mapl_n('fr', fzf.lsp_references, 'Find References')
--   h.mapl_n('fl', fzf.resume, 'Find Last')
--   h.mapl_n('fI', fzf.grep, 'Grep')
--   h.mapl_n('fi', fzf.live_grep, 'Find In Files')
--   -- h.mapl_v('fc', h.with_opts(tlg.grep_visual_selection, { initial_mode = 'normal' }), 'Find Current Selection')
--   h.mapl_n('fw', fzf.grep_cword, 'Find word under cursor')
--   h.mapl_n('fg', fzf.git_status, 'Find changed git files')
--   -- h.mapl_n('fd', tb.diagnostics, 'Find Diagnostics')
--   h.mapl_n('fm', fzf.marks, 'Find Marks')
--   h.mapl_n('/', fzf.blines, 'Fuzzy search in current buffer')
--
--   h.mapl_n('fhs', fzf.search_history, 'Find in search history')
--   h.mapl_n('fhc', fzf.command_history, 'Find in command history')
--
--   h.mapl_n('Ht', fzf.help_tags, 'Help Tags')
--   h.mapl_n('Hk', fzf.keymaps, 'Help Keymaps')
--   h.mapl_n('Hc', fzf.commands, 'Help Commands')
--   h.mapl_n('Hp', fzf.builtin, 'Help Pickers')
-- end)
